...
if(isset($_POST['signUp'])){
    ...
    $checkEmail = "SELECT * FROM employees WHERE email = ?";
    ...
    if($result->num_rows > 0){
        ...
        $insertQuery = "INSERT INTO employees (firstName, lastName, email, password, contactNumber, address)
                        VALUES (?, ?, ?, ?, ?, ?)";
        ...
        if($stmt->execute()){
            ...
            header("Location: ../management.php"); // Redirect to menu.php
            exit();
        } else {
